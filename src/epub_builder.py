...
class EPUBBuilder:
    ...
    def build(
        ...
        # Summary chapter (Today's Highlights) - before articles
        if summary:
            summary_chapter = self._create_summary_chapter(summary)
    ...
    def _create_summary_chapter(self, summary: str) -> epub.EpubHtml:
        """Create AI summary chapter (Today's Highlights).
        
        Args:
            summary: AI-generated summary text (may contain markdown)
        ...
        <body>
            ...
            <div class="ai-disclaimer">
                <em>This summary was generated by AI (GPT-4o-mini)</em>
            </div>
        </body>
        </html>
        """
...
def build_epub(
    ...
    Args:
        ...
        summary: AI-generated summary for "Today's Highlights" chapter
        
    Returns:
        Path to EPUB file
    """
    builder = EPUBBuilder()
    return builder.build(articles, digest_type, errors, output_path, summary)
